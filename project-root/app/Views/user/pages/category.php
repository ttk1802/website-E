            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleFormControlSelecti">
                                    Lọc theo
                                </label>
                    ...
                    <?php
                       if (!empty($Category_products)){                        
                        ?>
                    <h2 class="title text-center"><?php echo @$title." ".@$namecate[0]['TenDM'] ?> </h2>
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <p><?=$products['TenMH']?></p>
                                    <?php if(@$products['SL_TON']==0 ){
                                       ?>
                                    <h5>Đã hết hàng</h2>
                                        <?php
                                    }else{
                                        echo '<h5>' . 'Số lượng '. @$products['SL_TON'] .'</h2>';
                                    } ?>
                                        <a href="
                                    <?php echo base_url('Product/'.$products['MaMH']."/".$products['slugsp'])?>"
                                            class="btn btn-default add-to-cart"><i class="fa fa-eye"></i>Details</a>
                                        <a href="<?php echo base_url('AddCart/'.$products["MaMH"]."//".$products['slugsp'])?>"
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <?php if (isset($products['MaDM']) || isset($pagi_path)) {
                         $pagi_path='Category/'.$products['MaDM'].'/'.$products['slugsp']; 
