        ...
        <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a href="<?php echo base_url('Category/'.$category['MaDM']."//".$category['slug'])?>">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <?php
                       if (!empty($Category_products)){
                        ...
                        ?>
                        <h2 class="title text-center"><?php echo @$namekey ?> </h2>
                        <?php
                       }else{
                            ?>
                            <h2 class="title text-center"><?php echo "Không có sản phẩm nào" ?> </h2>
                              <?php
                              
                       }
                    ?>
                          <?php if($Category_products): ?>
                    <?php foreach(@$Category_products as $products): ?>
                  
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="frontend/images/product/<?php echo $products['HinhAnh'] ?>" alt="" />
                                    <h2>$<?=$products['Giaban']?></h2>
                                    <p><?=$products['TenMH']?></p>
                                    <a href="
                                    <?php echo base_url('Product/'.$products['MaMH']."/".$products['slugsp'])?>"
                                        class="btn btn-default add-to-cart"><i class="fa fa-eye"></i>Details</a>
                                    <a href="<?php echo base_url('AddCart/'.$products["MaMH"]."//".$products['slugsp'])?>" class="btn btn-default add-to-cart"><i
                ...
                <div class="d-flex justify-content-end">
                    <?php if ($pager) :?>
                    <?php if (isset($products['MaDM']) || isset($pagi_path)) {
                         $pagi_path='Search'; 
