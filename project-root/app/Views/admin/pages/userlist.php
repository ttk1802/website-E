        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <form action="<?=base_url();?>/admin/user/act_update" method="post">
                    <div class="modal fade bd-example-modal-lg" id="edit_<?=@$user['MaTK']?>" tabindex="-1"
                                ...
                                <div class="modal-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="role1" id="role" class="form-control" required
                                                value="<?=@$user['quyen']?>">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn mb-2 btn-secondary"
                                        data-dismiss="modal">Close</button>
                                    <input type="hidden" value="<?=$user['MaTK']?>">
                                            ...
                                            <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a type="button" data-toggle="modal"
                                                        data-target="#edit_<?=$user['MaTK']?>" class="dropdown-item"
                                                        href="">Edit</a>
                                                    <a type="button" data-toggle="modal"
                                                        data-target="#remove_user-<?=$user['MaTK']?>"
